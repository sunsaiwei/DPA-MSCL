...
from utils.load_data_MSDC import get_Hugoton_Panoma_multiscale
...
def parse_arguments():
    ...
    parser.add_argument('--beta', default=0.40, type=float,
...
def main():
    ...
    if args.dataset == "hp":
        x_train, x_test, data_train_loader, y_train, y_test, test_loader = get_Hugoton_Panoma_multiscale(
            args.data_path1, args)
