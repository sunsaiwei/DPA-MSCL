...
from utils.load_data_MSDC import get_blind_daqing_multiscale
...
def main():
    ...
    if args.dataset == "blind_daqing":
        x_train, x_test, data_train_loader, y_train, y_test, test_loader = get_blind_daqing_multiscale(
            args.data_path3, args.data_path4, args)
