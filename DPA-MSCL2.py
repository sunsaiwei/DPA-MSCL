...
def main():
    ...
    plt.title(f'Confusion Matrix for DPA_BCL on {args.dataset} {args.blind_well1} {args.blind_well2}')
    plt.xlabel('Predicted')
    plt.ylabel('Actual')
    confusion_matrix_save_path = save_path + f'confusion_matrix/'
    plt.savefig(confusion_matrix_save_path + f'DPA_BCL_run.png')
    plt.show()
    ...
    plt.title(f'Accuracy Curves for DPA_BCL on {args.dataset} {args.blind_well1} {args.blind_well2}')
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy')
    plt.legend()
    accuracy_curve_save_path = save_path + f'accuracy_curve/'
    plt.savefig(accuracy_curve_save_path + f'DPA_BCL_run.png')
    plt.show()
