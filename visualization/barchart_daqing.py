...
facies_labels = ['SS', 'DS', 'HS', 'Hgs',  'BS', 'T']
# 确保颜色数量与标签数量匹配
facies_colors = ['#fd9700', '#fd9700', '#fd9700', '#fd9700', '#fd9700', '#fd9700']

#读取数据集
data = pd.read_excel("../dataset/daqing.xlsx")


data.dropna(inplace=True)

# 计算每个岩性的样本数和百分比
facies_counts = data['Face'].value_counts().sort_index()
