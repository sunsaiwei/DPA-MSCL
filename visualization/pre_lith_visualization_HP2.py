...
blind_data = df[df['Well Name'] == 'SHANKLE'].dropna()
...
data_list_ours = data_list_ours[:449]  # 直接取后449条
...
data_list_smote = data_list_smote[:449]  # 取后449条
...
data_list_sgan = data_list_sgan[:449]  # 取后449条
